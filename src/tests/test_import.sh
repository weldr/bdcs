...
$IMPORT $METADATA_DB $CENTOS_REPO https://download-ib01.fedoraproject.org/pub/epel/7/x86_64/a/abc-1.01-9.hg20160905.el7.x86_64.rpm
if [ $? -ne 0 ]; then
...
$IMPORT $METADATA_DB $CENTOS_REPO https://s3.amazonaws.com/weldr/https-import-repo/
if [ $? -ne 0 ]; then
